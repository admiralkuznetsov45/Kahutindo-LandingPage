// Data aktivitas dari gambar Legal Aid & Alternative Dispute Resolution
const legalAidItems = [
...
/**
 * Komponen untuk menampilkan daftar aktivitas Legal Aid & Alternative Dispute Resolution
 * dalam tabel dengan latar belakang gradien spesifik.
 */
// Anda bisa menyingkat nama fungsi jika dirasa terlalu panjang, misal: LegalAidADR
        ...
        <table className="w-full bg-white bg-opacity-60 rounded-lg shadow-md border border-gray-300">
          ...
          <thead className="bg-white bg-opacity-80">
            <tr>
              ...
              <th className="p-3 text-left font-semibold text-gray-700 border-b border-gray-300">Service / Activity</th> {/* Ubah judul kolom jika perlu */}
            </tr>
          </thead>

          {/* Badan Tabel (Body) */}
          <tbody>
            {/* Melakukan iterasi (looping) pada array legalAidItems */}
